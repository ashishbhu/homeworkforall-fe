$(document).ready(function() {
    	...
    	$.ajax({
    		...
    		success:function(result){
    			  ...
    			  if(result.paytmWalletBalanceResult != null && result.razorpayBalanceDTO != null) {
   		       	   $("section.content-header h1").html("<span style='background-color:#f0e665;'>Gateway Balance ( Paytm : "+parseFloat(result.paytmWalletBalanceResult.walletBalance).toFixed(2)+", Cashfree : "+ parseFloat(result.razorpayBalanceDTO.cashfreeBalanceAmount).toFixed(2)+", Axis IMPS : "+result.razorpayBalanceDTO.axisImpsBalance +", Axis UPI : "+result.razorpayBalanceDTO.axisUpiBalance +")</span> </br> <span style='background-color:#c8d6c3;'>Paytm (Queued[Amount : "+result.paytmWalletBalanceResult.queuedAmount+", Count : "+ result.paytmWalletBalanceResult.count+"], Blocked[Amount : "+result.paytmWalletBalanceResult.blockedAmount+", Count : "+ result.paytmWalletBalanceResult.blockedCount+"])</span> </br> <span style='background-color:#d6c6b4;'>IMPS (Queued[Amount : "+result.razorpayBalanceDTO.impsPendingAmount+", Count : "+result.razorpayBalanceDTO.impsPendingCount+"], Blocked[Amount : "+result.razorpayBalanceDTO.impsBlockedAmount+", Count : "+result.razorpayBalanceDTO.impsBlockedCount+"])</span> </br> <span style='background-color:#d6c6b4;'>UPI (Queued[Amount : "+result.razorpayBalanceDTO.upiPendingAmount+", Count : "+result.razorpayBalanceDTO.upiPendingCount+"], Blocked[Amount : "+result.razorpayBalanceDTO.upiBlockedAmount+", Count : "+result.razorpayBalanceDTO.upiBlockedCount+"])</span>");
   		          } else {
   		       	   $("section.content-header h1").html("<span style='background-color:#f0e665;'>Paytm ( Available Balance : "+parseFloat(result.paytmWalletBalanceResult.walletBalance).toFixed(2)+", Queued[Amount :"+ result.paytmWalletBalanceResult.queuedAmount+", Count :"+ result.paytmWalletBalanceResult.count+"], Blocked[Amount : "+result.paytmWalletBalanceResult.blockedAmount+", Count : "+ result.paytmWalletBalanceResult.blockedCount+"])</span>");
   		          }
    		},
	...
	function callToResults() {
		...
		"&fromAmount="+$("#fromAmount").val()+"&toAmount="+$("#toAmount").val()+"&walletType="+walletType +"&isFromC91Wallet="+isFromC91Wallet+"&forC91WalletWithdrawal="+$("#forC91WalletWithdrawal").val()+"&forNonC91WalletWithdrawal="+$("#forNonC91WalletWithdrawal").val();
...
function callToSearchResults() {
	...
	+"&fromDate="+$("#fromDate").val()+"&toDate="+ $("#toDate").val()+"&forC91="+$("#forC91").val()+"&fromAmount="+$("#fromAmount").val()+"&toAmount="+$("#toAmount").val() +"&walletType="+walletType+"&isFromC91Wallet="+isFromC91Wallet
	+"&forC91WalletWithdrawal="+$("#forC91WalletWithdrawal").val()+"&forNonC91WalletWithdrawal="+$("#forNonC91WalletWithdrawal").val();

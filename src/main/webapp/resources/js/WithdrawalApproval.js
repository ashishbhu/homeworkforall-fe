...
function callToResult(){
	...
	var reportUrl = SITEBASEURL + "withDrawal/withdrawalApprovedUserListing?fromDate=" +$('#fromDate').val()+"&toDate="+$("#toDate").val();
	var table = $('#withdrawalTable').dataTable({
		...
		"aoColumns": [{
			...
			"sTitle": "Last Approved Date",
			"mData": "lastApprovedDate",
			"bSortable": false
		},{
			"sTitle": "Approved Count",
			"mData": "approvedCount",
			"bSortable": false
			
		},{
			"sTitle": "Approval Request Count",
			"mData": "requestCount",
			"bSortable": false
		},{

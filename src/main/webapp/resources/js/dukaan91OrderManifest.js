$(document).ready(function() {
	...
	var reportUrl = SITEBASEURL + "dukan91OpsOrder/list?orderState="+ $("#orderStateId").val();
	
	   $("section.content-header h1").html("Dukaan91 Manifests");
...
function callToSearchResults() {
	...
	var reportUrl = SITEBASEURL + "dukan91OpsOrder/manifest-pagelist?courierProviderId="+ $("#courierProviderId").val();

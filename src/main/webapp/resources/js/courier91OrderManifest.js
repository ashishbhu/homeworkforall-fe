$(document).ready(function() {
	...
	var reportUrl = SITEBASEURL + "courier91OpsOrder/list";
	
	
     
	   $("section.content-header h1").html("Courier91 Manifests");
	   if($("#fromC91Page").val() == 'true'){
		   $('<a href= "'+reportUrl+'" class="btn btn-custom pull-right" style="margin-top: -5px;">Back</a>')
	         .insertAfter("section.content-header h1");
	   } else {
		   $('<a href= "'+SITEBASEURL + "courier91OpsOrder/list-v1"+'" class="btn btn-custom pull-right" style="margin-top: -5px;">Back</a>')
	         .insertAfter("section.content-header h1");
	   }
...
function callToSearchResults() {
	...
	var reportUrl = SITEBASEURL + "courier91OpsOrder/manifest-pagelist?courierProviderId="+ $("#courierProviderId").val();
													...
													.on(
															...
															function() {
																...
																var path = SITEBASEURL
																		+ 'courier91OpsOrder/manifest-receipt-by-identifier/'
																		+ data.identifier;
																$(
																		"<form action='"
																				+ path
									...
									.on(
											...
											function() {
												...
												var data = table
														...
														.data();
												var path = SITEBASEURL
														+ 'courier91OpsOrder/manifest-invoice-by-identifier/'
														+ data.identifier;
												$(
														"<form action='"
																+ path

...
var reportUrl = SITEBASEURL + "local91OpsOrder/pagelist-for-local91-fraud-detection-orders?fraudDetectionId="
...
function callToView(orderId){
	...
	window.location.href = SITEBASEURL + 'local91OpsOrder/get/'+orderId+"?fromFraudDetectionPage=true&fraudDetectionId="
				+ $("#fraudDetectionId").val();
}
